...
export default function EmptyCart({
  ...
  return (
    ...
    >
      ...
      <img src="/images/illustrations/castor.jpg" aria-hidden="true" alt="" className="absolute w-[140%] max-w-none left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.15] mix-blend-multiply pointer-events-none select-none" />
